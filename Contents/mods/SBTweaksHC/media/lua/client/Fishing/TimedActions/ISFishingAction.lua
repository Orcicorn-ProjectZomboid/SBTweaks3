-- MOD: Brick wants Fish 2696281225
-- > Fish size chance now scales off fishing level
-- > High fishing levels have a better chance of catching bigger fish
-- > Small fish become nonexistant past Fishing level 5
-- > Added new fish size: Prize
-- > 50% larger than Big fish
-- > Adjusted Fish size chance distribution
-- > At Fishing level 0, 10% Big, 40% Medium, 45% Small (5% Prize)*
-- > Made Fish slightly more nutritious
...
--    print("got a fish ", fishType.size, size, minSize, maxSize, " % ", scaleMod, "full scale: ", (baseScale + scaleMod));
    local nutritionFactor = 2.5 * weightKg / baseWeightLb;
    ...
    if not fish.noNameChange then
        fishToCreate:setName(fishType.size .. " " .. fish.name .. " - " .. size .. "cm");
    end
