-- If True Actions is installed, then load and tweak the settings for the new furniture
-- Otherwise, don't even bother and just ignore everything in here to prevent errors
...
-- PERSONAL TWEAKS *************************************************************
-- *****************************************************************************
    -- Tweak outdoor White Plastic chair to woodstock's preference
    TrueActions.WorldSeatObject["furniture_seating_outdoor_01_16"] = {0.70, 0.40}
    TrueActions.WorldSeatObject["furniture_seating_outdoor_01_17"] = {0.40, 0.70}

    -- Add front-half of the cloth yard chairs
    TrueActions.WorldSeatObject["furniture_seating_outdoor_01_25"] = {0.50, 1.50}   -- North, Top
    TrueActions.WorldSeatObject["furniture_seating_outdoor_01_24"] = {0.50, 0.60}   -- North, Bottom
    TrueActions.WorldSeatObject["furniture_seating_outdoor_01_26"] = {1.40, 0.50}   -- East, Top
    TrueActions.WorldSeatObject["furniture_seating_outdoor_01_27"] = {0.50, 0.50}   -- East, Bottom

    -- Add Wooden Baseball Like Bench
    TrueActions.WorldSeatObject["furniture_seating_outdoor_01_32"] = {0.50, 0.70}   -- North (2 Lefts)
    TrueActions.WorldSeatObject["furniture_seating_outdoor_01_33"] = {0.50, 0.70}   -- North (1 Left)
