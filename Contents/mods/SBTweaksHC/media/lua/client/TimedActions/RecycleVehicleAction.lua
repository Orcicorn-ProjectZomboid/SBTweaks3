...
--[[
    This overpowers the RecycleVehicleAction.lua from the Vehicle Recycling Mod
    which is currently broken and does not delete the vehicle.
    https://steamcommunity.com/workshop/filedetails/?id=2289429759

    If that mod ever gets updated delete just this one file.
]]--
