-- "Backpack Borders" (2808679062) 
--  Adjusts the background color and adds a border to inventory container buttons to
--  allow for better visiblity. Particularly nice with dark colored backpacks.
